...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://ebnchwtgzavxuvxdhvvp.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVibmNod3RnemF2eHV2eGRodnZwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc0MTQ0ODksImV4cCI6MjA4Mjk5MDQ4OX0.wE-JtnFFUpYyjzlW6IrhPGZZZEeWAPdQpn7K776T8c0");
...
async function getEmployeeById(id) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServiceSupabase"])();
    const { data, error } = await supabase.from('employees').select('*').eq('id', id).single();
    if (error) return null;
    return data;
}
function generateLoginId(companyCode, firstName, lastName, joiningYear, serialNumber) {
...
async function POST(request) {
    try {
        ...
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServiceSupabase"])();
        const { data: employee, error } = await supabase.from('employees').select('*').eq('login_id', loginId).eq('is_active', true).single();
        if (error || !employee) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const isValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(password, employee.password_hash);
        if (!isValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid credentials'
            }, {
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])(authUser);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cdfb084._.js.map